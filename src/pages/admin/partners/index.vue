  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <tr v-for="i in 5" :key="i" class="hover:bg-slate-50/50 transition-colors">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 w-11 h-11 rounded-xl bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-violet-500/20">
                    G
                  </div>
                  <div class="ml-4">
                    <div class="text-sm font-semibold text-slate-900">Genory Tech</div>
                    <div class="text-xs text-slate-500">RC123456</div>
                  </div>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right">
                <div class="flex items-center justify-end space-x-2">
                  <button class="inline-flex items-center p-2 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                  </button>
                  <button class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-slate-600 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors">
                    View
      ...
      <div v-if="false" class="text-center py-12">
        ...
        <h3 class="mt-4 text-sm font-medium text-slate-900">No partners yet</h3>
        <p class="mt-1 text-sm text-slate-500">Get started by creating a new partner.</p>
        <router-link
          to="/admin/partners/create"
